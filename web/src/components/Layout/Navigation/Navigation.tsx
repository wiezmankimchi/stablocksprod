...
const SubMenuButton = ({ name, to, basePath }: SubMenuButtonProps) => {
  return (
    <NavLink
      to={to}
      basePath={basePath}
      className="group flex w-full items-center rounded-md py-2 pl-11 pr-2 text-left text-base font-medium transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-gray-800 md:text-sm"
        ...
        (item, i) =>
          ...
          (!item.children ? (
            <div key={item.name}>
              <NavLink
                to={item.to}
                className="group flex w-full items-center rounded-md py-2 pl-2 pr-1 text-left text-base font-medium transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 md:text-sm"
                nonActiveClassName="text-gray-300 hover:bg-gray-700 hover:text-white"
                activeClassName="bg-gray-900 text-gray-300"
              >
                <item.icon
